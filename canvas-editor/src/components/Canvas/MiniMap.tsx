export function MiniMap() {
  return (
    <div className="absolute top-4 right-4 z-20 w-32 h-20 bg-white/90 backdrop-blur-sm rounded-lg border border-surface-3 shadow-sm overflow-hidden" data-no-canvas-wheel>
